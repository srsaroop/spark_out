...
["_isolate_helper", "dart:_isolate_helper", , H, {
  ...
  RawReceivePortImpl: {
    ...
    close$0: function() {
      ...
      this._isClosed = true;
      this._handler = null;
      var t1 = init.globalState.currentContext;
...
["dart.async", "dart:async", , P, {
  ...
  _Future__propagateToListeners_handleValueCallback: {
    "": "Closure:13;box_1,box_2,listener_3,zone_4",
    call$0: function() {
...
["spark.services_impl", "services_impl.dart", , B, {
  "": "",
  main: [function(args, sendPort) {
    $._printSendPort = sendPort;
    B.ServicesIsolate$(sendPort);
  }, "call$2", "main$closure", 4, 0, 8],
  ServicesIsolate: {
    "": "Object;_sendPort,_onResponseMessage,_onHostMessage",
    ServicesIsolate$1: function(_sendPort) {
      var hostMessageController, responseMessageController, receivePort, t1;
      hostMessageController = P.StreamController_StreamController$broadcast(null, null, false, N.ServiceActionEvent);
      responseMessageController = P.StreamController_StreamController$broadcast(null, null, false, N.ServiceActionEvent);
      this._onHostMessage = H.setRuntimeTypeInfo(new P._BroadcastStream(hostMessageController), [H.getTypeArgumentByIndex(hostMessageController, 0)]);
      this._onResponseMessage = H.setRuntimeTypeInfo(new P._BroadcastStream(responseMessageController), [H.getTypeArgumentByIndex(responseMessageController, 0)]);
      receivePort = P.ReceivePort_ReceivePort();
      this._sendPort.send$1(new H._NativeJsSendPort(receivePort._rawPort, init.globalState.currentContext.id));
      t1 = receivePort._controller;
      t1.toString;
      H.setRuntimeTypeInfo(new P._ControllerStream(t1), [null]).listen$4$cancelOnError$onDone$onError(new B.ServicesIsolate_closure(this), null, null, null);
    },
    static: {ServicesIsolate$: function(_sendPort) {
        var t1 = new B.ServicesIsolate(_sendPort, null, null);
        t1.ServicesIsolate$1(_sendPort);
        return t1;
      }}
  },
  ServicesIsolate_closure: {
    "": "Closure:11;this_0",
    call$1: function(arg) {
      this.this_0._sendPort.send$1(arg);
    }
  }
},
1],
["spark.utils", "lib/utils.dart", , N, {
  "": "",
  ServiceActionEvent: {
    "": "Object;"
  }
...
N.ServiceActionEvent.$isObject = true;
J.JSInt.$isint = true;
