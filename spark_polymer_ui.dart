...
class SparkPolymerUI extends SparkWidget with ChangeNotifier  {
  @reflectable @observable bool get developerMode => __$developerMode; bool __$developerMode = false; @reflectable set developerMode(bool value) { __$developerMode = notifyPropertyChange(#developerMode, __$developerMode, value); }
  @reflectable @observable SuggestOracle get searchOracle => __$searchOracle; SuggestOracle __$searchOracle; @reflectable set searchOracle(SuggestOracle value) { __$searchOracle = notifyPropertyChange(#searchOracle, __$searchOracle, value); }
